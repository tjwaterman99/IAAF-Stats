...
os.chdir('/Users/tom/Projects/IAAF-Stats/Website Links/IAAF World Champs')
...
# Collect results and store as a dataframe
results = [parse_web_page(page) for page in os.listdir()]
df = pd.DataFrame([result for event in results for result in event])

if __name__ == '__main__':
    # Dump results to a csv in the  following folder:
    os.chdir('/Users/tom/Projects/IAAF-Stats/Scripts/')
    df.to_csv('IAAF_Results.csv')
